...
path_json = 'data_pipeline/sms1_json.json'
U_path_pkl = 'data_pipeline/sms1_pickle_U.pkl' #unlabelled data
T_path_pkl = 'data_pipeline/sms1_pickle_T.pkl' #test data
...
# # Filter out arrays with NaN and None values
