...
U_path_pkl = 'data_pipeline/sms1_pickle_U.pkl'
L_path_pkl = 'data_pipeline/sms1_pickle_L.pkl'
V_path_pkl = 'data_pipeline/sms1_pickle_V.pkl'
T_path_pkl = 'data_pipeline/sms1_pickle_T.pkl'
...
jl = JL(path_json, n_lfs, n_features, feature_model = 'rcnn')
